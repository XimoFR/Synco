...
export default function RegisterPage() {
  ...
  return (
    ...
    >
      ...
      {/* Atmospheric gradient — lime heavy to differentiate from login */}
      <div
        style={{
          position:      'absolute',
          inset:         0,
          pointerEvents: 'none',
          background:
            'radial-gradient(ellipse 65% 50% at 15% -5%, rgba(124,58,237,0.2) 0%, transparent 55%),' +
            'radial-gradient(ellipse 60% 50% at 90% 108%, rgba(212,255,79,0.1) 0%, transparent 52%)',
        }}
      />
